...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("setup_server_tip", "可可️🌥️如果需要更快连接速度，你可以选择自建服务器"),
        ...
        ("powered_by_me", "可可️🌥️由 RustDesk 提供支持"),
